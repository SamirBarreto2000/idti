...
<body>
    ...
    <section id="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li>
                <a href="#" class="active"><i class='bx bxs-user icon'></i> Pacientes <i
                        class='bx bx-chevron-right icon-right'></i></a>
                <ul class="side-dropdown">
            ...
            <form action="" enctype="multipart/form-data" method="POST" autocomplete="off"
                ...
                <div class="containerss">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <label for="psw"><b>Grupo sanguíneo del paciente</b></label><span
                                class="badge-warning">*</span>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <label for="psw"><b>Fecha de nacimiento del paciente</b></label><span
                                class="badge-warning">*</span>
                            <input type="date" name="cump" required>
                        </div>
                        <!-- Agrega más grupos de tres campos según sea necesario -->
