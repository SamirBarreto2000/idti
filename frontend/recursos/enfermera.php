...
<head>
    ...
    <title>Clínica Salud | Listado de enfermeras</title>
</head>
...
<body>
    ...
    <section id="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li>
                <a href="#"><i class='bx bxs-book-alt icon'></i> Citas <i
            ...
            <li>
                <a href="#" class="active"><i class='bx bxs-user-pin icon'></i> Recursos humanos<i
                        class='bx bx-chevron-right icon-right'></i></a>
                <ul class="side-dropdown">
                                    ...
                                    <?php foreach ($data as $d): ?>
                                        <tr>
                                            ...
                                            <td data-title="Estado">
                                                ...
                                                <label class="switch">
                                                    <input type="checkbox" id="<?= $d->idnur ?>" value="<?= $d->state ?>"
                                                        <?= $d->state == '1' ? 'checked' : ''; ?> />
                                            ...
                                            <td>
                                                <a title="Actualizar"
                                                    href="../recursos/enfermera_editar.php?id=<?php echo $d->idnur ?>"
                                                    class="fa fa-pencil tooltip"></a>
                                                <a title="Información"
                                                    href="../recursos/enfermera_info.php?id=<?php echo $d->idnur ?>"
                                                    class="fa fa-info"></a>
